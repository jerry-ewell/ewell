...
import { metamask, walletConnectIcon, nightElfIcon } from '../assets/images';
import { injected, walletConnect } from '../walletConnectors';
...
export const DEFAULT_CHAIN = SupportedELFChainId.MAINNET;
